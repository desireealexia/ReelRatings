"""
Django settings for reelratings project.
...
ROOT_URLCONF = 'reelratings.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [TEMPLATES_DIR, APP_TEMPLATES_DIR], # Include both paths
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'reelratings.wsgi.application'
